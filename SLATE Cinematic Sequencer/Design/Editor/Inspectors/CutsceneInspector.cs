...
namespace Slate
{
    ...
    public class CutsceneInspector : Editor
    {
        ...
        public override void OnInspectorGUI() {
            ...
            GUILayout.Space(5);
            if ( GUILayout.Button("EDIT IN HOSHINO SKILL") )
            {
                var skillEditorType = Type.GetType("Hoshino.SkillEditor, HoshinoSkill");
                if (skillEditorType != null)
                {
                    var showWindowMethod = skillEditorType.GetMethod(
                        "ShowWindow",
                    ...
                    showWindowMethod.Invoke(null, new object[] { cutscene });
                }
            }
            GUILayout.Space(5);
