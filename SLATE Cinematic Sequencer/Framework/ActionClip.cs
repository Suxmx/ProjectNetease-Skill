...
namespace Slate
{
    ...
    abstract public class ActionClip : MonoBehaviour, IDirectable, IKeyable
    {
        ...
        public Cutscene cutscene { get { return root as Cutscene; } }
        ...
        public virtual int GetLine() => _line; 
        [SerializeField,HideInInspector]protected int _line = 1;
        ...
        public virtual Color editorColor {
            get
            {
                return ((CutsceneTrack)(parent)).color;
            }
        }
